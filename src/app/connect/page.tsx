...
export default async function ConnectPage({ searchParams }: { searchParams: Promise<{ ref?: string, h?: string, topic?: string, chatslug?: string }> }) {
  ...
  const connectSteps: StepData[] = [
    ...
    {
      id: "contact",
      question: "ok cool, what phone number can they text you at if we get disconnected here? (your pre-vetted mortgage rep will only text you about this conversation today and your information is NOT shared with any other companies.)\n\n👇👇👇",
      isInput: true,
    }
  ];
